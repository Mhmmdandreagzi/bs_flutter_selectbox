...
class _BsSelectBoxState extends State<BsSelectBox>
    ...
    updateState(() {
      ...
      widget.serverSide!({'searchValue': searchValue}).then((response) {
        updateState(() {
          ...
          if (_wrapperOptions != null) _wrapperOptions!.update();
        });
      });
    });
  }
                ...
                children: [
                  Expanded(
                    child: Container(
                      ...
                      child: widget.controller.getSelectedAll().length == 0
  ...
  Widget renderSelected() {
    ...
    if (widget.controller.multiple)
      widget.controller.getSelectedAll().forEach(
        (option) {
          children.add(
            Container(
